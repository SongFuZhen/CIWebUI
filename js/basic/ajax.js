 ...
 */
var urlhead = 'http://192.168.1.123:3000/api/v2/';
        ...
        $.ajax({
            ...
            complete: function (XMLHttpRequest, status) {
                ...
                DialogBtn[0].onclick = function () {
                    /*document.getElementsByClassName('Masked')[0].style.display = 'none';
                     document.getElementsByClassName('SimpleDialog')[0].style.display = 'none';*/
                ...
                /* if (status == 'timeout') {//超时,status还有success,error等值的情况
                 ...
                 //document.getElementById('Loading').parentNode.removeChild(document.getElementById('Loading'));
                 //SimpleDialog("Timeout !", "Call API TimeOut", 'OK', 'block');
