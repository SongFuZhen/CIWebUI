...
(function ($) {
    ...
    $.fn.tagEditor3parments = function (options, val, title, id, blur) {
        ...
        return selector.each(function () {
            ...
            var ed = $('<ul ' + (o.clickDelete ? 'oncontextmenu="return false;" ' : '') + 'class="tag-editor"  style="overflow: auto;background: #f2f2f2;font-size: 12px;font-weight: bold;" ></ul>').insertAfter(el);
